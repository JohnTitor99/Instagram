...
from apps.base.models import Comment, Follower, Post, Saved, UserProfile, Reply, Hashtag

from apps.base.common import created_dict # a file with functions for executing required tasks
